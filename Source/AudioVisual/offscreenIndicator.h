 ...
 */
UCLASS()
class AUDIOVISUAL_API UoffscreenIndicator : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
	 * thanks to https://forums.unrealengine.com/t/easy-offscreen-indicator-blueprint-node/21342
	 * 
